...
const EditBook = () => {
    ...
    const fetchBook = async () => {
      try {
        ...
        if (res.book) {
          ...
          setPrice(book.price || "")
          setExistingCover(book.cover_url)
          setExistingPdf(book.book_file_url)
        }
      } catch {
        navigate("/")
      } finally {
  ...
  if (loadingBook) {
    return <div className="container mx-auto px-4 py-12">Loading book...</div>
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-navy">Edit Book</h1>
      </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                {existingCover ? "Change Cover" : "Upload Cover"}
              </button>
              {coverPreview && (
                <button
                  type="button"
            ...
            <div className="mt-3">
              {coverPreview ? (
                <img src={coverPreview} alt="Cover preview" className="w-32 h-40 object-cover rounded-lg" />
              ) : existingCover ? (
                <img src={existingCover} alt="Current cover" className="w-32 h-40 object-cover rounded-lg" />
              ) : (
                <div className="w-32 h-40 border-2 border-dashed border-border-light rounded-lg flex items-center justify-center text-neutral-light">
                  <span>No cover</span>
                </div>
              )}
            </div>
